...
<head>
    ...
    <!-- Css Styles -->
    <link rel="stylesheet" href="{{ asset('auth/css/css/bootstrap.min.css')}}" type="text/css">
    <link rel="stylesheet" href="{{ asset('auth/css/css/font-awesome.min.css)}}" type="text/css">
    <link rel="stylesheet" href="{{ asset('auth/css/css/elegant-icons.css')}}" type="text/css">
    <link rel="stylesheet" href="{{ asset('auth/css/css/nice-select.css')}}" type="text/css">
    <link rel="stylesheet" href="{{ asset('auth/css/css/jquery-ui.min.css')}}" type="text/css">
    <link rel="stylesheet" href="{{ asset('auth/css/css/owl.carousel.min.css')}}" type="text/css">
    <link rel="stylesheet" href="{{ asset('auth/css/css/slicknav.min.css')}}" type="text/css">
    <link rel="stylesheet" href="{{ asset('auth/css/css/style.css')}}" type="text/css">
</head>
