...
<section class="checkout spad">
    <div class="container">
        <div class="row">
            <div class="col-lg-12">
                <h6><span class="icon_tag_alt"></span> Bạn có phiếu giảm giá? <a href="#">bấm vào đây</a> để nhập mã của bạn</h6>
            </div>
        </div>
                ...
                <div class="row">
                    <div class="col-lg-8 col-md-6">
                        ...
                        <div class="checkout__input">
                            ...
                            <input type="text" placeholder="Ghi chú về đơn đặt hàng của bạn, ví dụ: lưu ý đặc biệt khi giao hàng.">
                        </div>
                    </div>
