    ...
    <section class="featured spad">
        <div class="container">
                    ...
                    {{-- <div class="featured__controls">
                        <ul>
                            ...
                            @foreach ($categories as $indexCategory => $categoryitem)
                                <li data-filter=".product{{ $categoryitem->category_id }}">
            ...
            <div class="row featured__filter">
                @foreach ($products as $key => $productListItem)
                    <div class="col-lg-4 col-md-6 col-sm-6">
                        <div class="product__item">
                            <div class="product__item__pic set-bg"
                                data-setbg="{{ asset($productListItem->product_vartar_path) }}">
                                <ul class="product__item__pic__hover">
                                    <li>
                                        <a href="{{ route('shop-details', ['id' => $productListItem->id]) }}">
                            ...
                            <div class="product__item__text">
                                ...
                                <h5>{{ number_format($productListItem->discount) }} VND</h5>
                                <p style="text-decoration:line-through;">
                                    {{ number_format($productListItem->price) }} VND</p>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="latest-prdouct__slider__item">
                                <a href="{{ route('shop-details', ['id' => $valueRecommend->id]) }}"
                                    ...
                                    <div class="latest-product__item__text">
                                        ...
                                        <p style="text-decoration:line-through;">
                                            {{ number_format($valueRecommend->price) }} VND</p>
                                    </div>
                                </a>
                            @else
                                <a href="{{ route('shop-details', ['id' => $valueRecommend->id]) }}"
                            ...
                            <div class="latest-prdouct__slider__item">
                                <a href="{{ route('shop-details', ['id' => $valueAppreci->id]) }}"
                                    ...
                                    <div class="latest-product__item__text">
                                        ...
                                        <p style="text-decoration:line-through;">
                                            {{ number_format($valueAppreci->price) }} VND</p>
                                    </div>
                                </a>
                            @else
                                <a href="{{ route('shop-details', ['id' => $valueAppreci->id]) }}"
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-6">
                        <div class="blog__item">
                            ...
                            <div class="blog__item__text">
                                ...
                                <h5><a
                                        href="{{ route('blog_details', ['id' => $blogNew->id]) }}">{{ $blogNew->name }}</a>
                                </h5>
                                <p>{{ $blogNew->slogan }}</p>
                            </div>
                        </div>
