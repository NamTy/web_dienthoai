            ...
            <table class="table table-bordered" style="border">
                <thead>
                    <tr>
                        ...
                        <th scope="col">Thời gian lập hóa đơn</th>
                    </tr>
                </thead>
                <tbody>
                    @php
                    ...
                    @foreach ($reports as $key => $report)
                        ...
                        @endphp
                        <tr>
                            <td scope="row" style=" border: 1px solid black;">{{ $key + 1 }}</td>
                            <td scope="row" style=" border: 1px solid black;">{{ $report->order_id }}</td>
                            <td scope="row" style=" border: 1px solid black;"  >{{ $report->order_status }}</td>
                            <td scope="row" class="text-right" style=" border: 1px solid black;">{{ $report->order_total }} vnđ</td>
                            <td scope="row" class="text-right" style=" border: 1px solid black;">{{ $report->created_at }}</td>
                        <tr>
                    @endforeach
                    <tr>
