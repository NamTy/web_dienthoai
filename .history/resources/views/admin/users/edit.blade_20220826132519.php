...
@section('content')
    ...
    <div class="container-fluid py-4">
        ...
        <div class="card">
            <form class="p-4" action="{{ route('users.update',['id'=>$user->id]) }}" method="post" enctype="multipart/form-data">
                @csrf
                ...
                <div class="form-group">
                    ...
                    <select name="role_id[]" id="" class="form-control border border-dark p-2 select_init"
                        multiple>
                        <option value=""></option>
