            ...
            <table class="table align-items-center mb-0">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <p>
                                <img src="https://cdn.tgdd.vn/Products/Images/42/92962/iphone-6-32gb-gold-hh-600x600-600x600-600x600.jpg" alt="">
                                {{-- {{$product->image_link}} --}}
                            </p>
                        </td>
                        <td>
                        ...
                        <td class="align-middle text-center text-sm">
                            <a href="{{route('menus.edit',['id'=>$products->id])}}" class="btn btn-info">Sửa</a>
                            <a href="{{route('menus.delete',['id'=>$products->id])}}" class="btn btn-primary">Xóa</a>
                        </td>
                    </tr>
                    @endforeach
                </tbody>
