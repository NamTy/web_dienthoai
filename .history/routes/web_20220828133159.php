...
Route::post('/insurance', [HomeController::class, 'searchInsurance'])->name('insurance.search');
...
Route::prefix('/admin')->group(function () {
    ...
    Route::prefix('users')->group(function () {
        ...
        Route::get('/customer/',[AdminUserController::class, 'showCustomer'])->name('user.customer');
    });
    ...
    Route::prefix('reports')->group(function () {
        ...
        Route::post('/report-product-qty', [AdminReportController::class, 'getReportProductQty'])->name('report.getProduct.qty');
    ...
    Route::prefix('/insurance')->group(function () {
        return $user->checkPermissionAccess('insurance_list');
        Route::get('/',[AdminInsuranceController::class,'index'])->name('insurance.view')->can('insurance_list');
        Route::get('/create',[AdminInsuranceController::class,'create'])->name('insurance.create')->can('insurance_add');
        Route::post('/create',[AdminInsuranceController::class,'store'])->name('insurance.store');
        Route::get('/edit/{id}',[AdminInsuranceController::class,'edit'])->name('insurance.edit')->can('insurance_edit');
        Route::post('/update/{id}',[AdminInsuranceController::class,'update'])->name('insurance.update');
        return $user->checkPermissionAccess('insurance_edit');
