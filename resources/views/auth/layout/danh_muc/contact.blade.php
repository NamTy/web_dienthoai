            ...
            <div class="row">
                ...
                <div class="col-lg-3 col-md-3 col-sm-6 text-center">
                    <div class="contact__widget">
                        ...
                        <h4>Địa chỉ</h4>
                        <p>Quán Gánh - Nhị Khê - Thường Tín - Hà Nội</p>
                    </div>
                </div>
                <div class="col-lg-3 col-md-3 col-sm-6 text-center">
                    <div class="contact__widget">
                        ...
                        <h4>Giờ Hoạt Động</h4>
                        <p>8h-21h hàng ngày trừ ngày lễ tết</p>
                    </div>
                </div>
                <div class="col-lg-3 col-md-3 col-sm-6 text-center">
                    <div class="contact__widget">
        ...
        <div class="map-inside">
            ...
            <div class="inside-widget">
                ...
                <ul>
                    ...
                    <li>Địa Chỉ:Quán Gánh - Nhị Khê - Thường Tín - Hà Nội</li>
                </ul>
            </div>
        </div>
    </div>
